...
* You could also add the service name, `service.name=paymentservice`, to the filter if there are error lines for multiple services, but in our case, this is not necessary.
